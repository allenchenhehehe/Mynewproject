...
public class ShoppingListServiceTest {
    ...
    public static void main(String[] args) {
        ShoppingListItemService service = new ShoppingListItemService();
        ...
        try {
            ...
            ShoppingListItem added1 = service.addItem(testUserId, item1);
            ...
            ShoppingListItem added2 = service.addItem(testUserId, item2);
            ...
            ShoppingListItem added3 = service.addItem(testUserId, item3);
        ...
        System.out.println("\n========== 測試 2: getShoppingList() ==========");
        try {
            List<ShoppingListItem> items = service.getShoppingList(testUserId);
        ...
        try {
            if (itemId1 == null) {
                ...
                ShoppingListItem updated = service.updateItem(testUserId, itemId1, updateData);  // ✅ 使用動態 ID
        ...
        try {
            if (itemId1 == null || itemId2 == null || itemId3 == null) {
                ...
                ShoppingListItem updated1 = service.togglePurchase(testUserId, itemId1, true);  // ✅ 動態 ID
                System.out.println("✅ 標記已購買: ID:" + itemId1 + " " + updated1.getIngredientName());
                
                ShoppingListItem updated2 = service.togglePurchase(testUserId, itemId2, true);  // ✅ 動態 ID
                System.out.println("✅ 標記已購買: ID:" + itemId2 + " " + updated2.getIngredientName());
                
                ShoppingListItem updated3 = service.togglePurchase(testUserId, itemId3, true);  // ✅ 動態 ID
        ...
        try {
            ...
            // 檢查購物清單
            List<ShoppingListItem> remaining = service.getShoppingList(testUserId);
        ...
        try {
            ...
            ShoppingListItem added = service.addItem(testUserId, testItem);
